...
@section('content')
    {{--    <div class="row">--}}
    {{--        <div class="col-xs-12">--}}
    {{--            {!! Form::open(array('route' => [$routePrefix.'.roles.update', $role->id], 'method' => 'PATCH','class'=>'form-horizontal')) !!}--}}
    {{--            <div class="box">--}}
    {{--                <div class="box-body">--}}
    ...
    {{--                    <a href="{{ route($routePrefix.'.roles.index') }}" class="btn btn-default btn-flat">Cancel</a>--}}
    {{--                </div>--}}
    {{--            </div>--}}
    {{--        {!! Form::close() !!}--}}
    {{--        <!-- /.box -->--}}
